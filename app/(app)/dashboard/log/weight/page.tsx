    ...
    <div className="px-4 md:px-6 lg:px-8 py-6 max-w-2xl mx-auto">
      <div className="mb-5">
        <div className="flex items-center gap-2 mb-1">
          <span
            className="material-symbols-outlined text-[24px] text-warning"
            style={{ fontVariationSettings: "'FILL' 1, 'wght' 400, 'GRAD' 0, 'opsz' 24" }}
          >
            {config.icon}
          </span>
          <h1 className="text-[24px] font-semibold tracking-[-0.02em] text-fg">Log weight</h1>
        </div>
        <p className="text-[15px] text-fg-muted">
          Track your body weight over time. One entry per day.
        </p>
      </div>
